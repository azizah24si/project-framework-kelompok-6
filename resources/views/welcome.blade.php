                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                        <div class="flex lg:justify-center lg:col-start-2">
                            <svg class="h-12 w-auto text-[#FF2D20] lg:h-16 lg:text-[#FF2D20]" viewBox="0 0 62 65" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <main class="mt-6">
                        <div class="text-center mb-8">
                            <a href="{{ route('proyek.index') }}" class="inline-block bg-[#FF2D20] hover:bg-red-700 text-white font-bold py-4 px-8 rounded-lg text-xl transition duration-300 shadow-lg">
                                🚀 Akses CRUD Proyek
                            </a>
                            <p class="mt-3 text-sm text-black">Kelola Data Proyek Pembangunan dengan Filter, Search & Pagination</p>
                        </div>
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            <a href="{{ route('proyek.index') }}" id="docs-card" class="flex flex-col items-start gap-6 overflow-hidden rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] md:row-span-3 lg:p-10 lg:pb-10">
                                ...
                                <div class="relative flex items-center gap-6 lg:items-end">
                                    <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                        ...
                                        <div class="pt-3 sm:pt-5">
                                            <h2 class="text-xl font-semibold text-black">CRUD Proyek Pembangunan</h2>

                                            <p class="mt-4 text-sm/relaxed">
                                                Sistem manajemen proyek pembangunan lengkap dengan fitur Create, Read, Update, Delete. Dilengkapi dengan pencarian data, filter berdasarkan tahun dan sumber dana, serta pagination otomatis. Klik untuk mulai mengelola data proyek!
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10">
                                ...
                                <div class="pt-3 sm:pt-5">
                                    ...
                                    <p class="mt-4 text-sm/relaxed">
                                        Laravel's robust library of first-party tools and libraries, such as <a href="https://forge.laravel.com" class="underline hover:text-black/70">Forge</a>, <a href="https://vapor.laravel.com" class="underline hover:text-black/70">Vapor</a>, <a href="https://nova.laravel.com" class="underline hover:text-black/70">Nova</a>, and <a href="https://envoyer.io" class="underline hover:text-black/70">Envoyer</a> help you take your projects to the next level. Pair them with powerful open source libraries like <a href="https://laravel.com/docs/billing" class="underline hover:text-black/70">Cashier</a>, <a href="https://laravel.com/docs/dusk" class="underline hover:text-black/70">Dusk</a>, <a href="https://laravel.com/docs/broadcasting" class="underline hover:text-black/70">Echo</a>, <a href="https://laravel.com/docs/horizon" class="underline hover:text-black/70">Horizon</a>, <a href="https://laravel.com/docs/sanctum" class="underline hover:text-black/70">Sanctum</a>, <a href="https://laravel.com/docs/telescope" class="underline hover:text-black/70">Telescope</a>, and more.
                                    </p>
                                </div>
                            </div>
                        </div>
