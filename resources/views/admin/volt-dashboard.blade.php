...
<head>
    ...
    <meta name="description" content="Volt - Bootstrap 5 Admin Dashboard">
...
<body>
    ...
    <!-- NOTICE: You can use the _analytics.html partial to include Google Analytics -->

    <nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-lg-none">
        <a class="navbar-brand me-lg-5" href="{{ url('/admin') }}">
