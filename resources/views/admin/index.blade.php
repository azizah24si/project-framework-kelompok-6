...
<body>
    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg navbar-dark px-lg-5">
            <a href="{{ url('/poseify') }}" class="navbar-brand ms-4 ms-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav mx-auto p-4 p-lg-0">
                    <a href="{{ url('/poseify') }}" class="nav-item nav-link active">Home</a>
                    <a href="#about" class="nav-item nav-link">About</a>
                    <a href="#services" class="nav-item nav-link">Services</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
                        <div class="dropdown-menu m-0">
                            <a href="#team" class="dropdown-item">Our Models</a>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        ...
                        <a href="#about" class="btn btn-outline-primary border-2 py-3 px-5 animated slideInDown">Explore
                            More</a>
                    </div>
                </div>
                    ...
                    <div class="team-item">
                        <div class="team-body">
                            <div class="team-before">
								...
								<img class="img-fluid" src="{{ asset('assets/img/team-6.jpg') }}" alt="">
                            <div class="team-after">
                                <span>22</span>
                                <span>185</span>
                                <span>55</span>
                    ...
                    <div class="team-item">
                        <div class="team-body">
                            <div class="team-before">
								...
								<img class="img-fluid" src="{{ asset('assets/img/team-7.jpg') }}" alt="">
                            <div class="team-after">
                                <span>22</span>
                                <span>185</span>
                                <span>55</span>
                    ...
                    <div class="team-item">
                        <div class="team-body">
                            <div class="team-before">
								...
								<img class="img-fluid" src="{{ asset('assets/img/team-8.jpg') }}" alt="">
                            <div class="team-after">
                                <span>22</span>
                                <span>185</span>
                                <span>55</span>
